...
describe('Twitch API Endpoints', () => {
    it('User data by name endpoint', async () => {
        const response = await axios.get(`${apiURL}${userApiURL}/data?streamer=${streamer}`);
    ...
    it('User endpoint', async () => {
        const response = await axios.get(`${apiURL}${userApiURL}?streamer=${streamer}`);
        expect(response.status).toEqual(200);
        const userData = response.data;
        expect(userData).toEqual(mock.login);
    });
    it('User ID endpoint', async () => {
        const response = await axios.get(`${apiURL}${userApiURL}/id?streamer=${streamer}`);
        expect(response.status).toEqual(200);
        const userData = response.data;
        expect(userData).toEqual(mock.id);
    });
    it('User name endpoint', async () => {
        const response = await axios.get(`${apiURL}${userApiURL}/name?streamer=${streamer}`);
        expect(response.status).toEqual(200);
        const userData = response.data;
        expect(userData).toEqual(mock.display_name);
    });
    it('User type endpoint', async () => {
        const response = await axios.get(`${apiURL}${userApiURL}/type?streamer=${streamer}`);
        expect(response.status).toEqual(200);
        const userData = response.data;
        expect(userData).toEqual(mock.type);
    });
    it('User description endpoint', async () => {
        const response = await axios.get(`${apiURL}${userApiURL}/description?streamer=${streamer}`);
        expect(response.status).toEqual(200);
        const userData = response.data;
        expect(userData).toEqual(mock.description);
    });
    it('User is affiliate endpoint', async () => {
        const response = await axios.get(`${apiURL}${userApiURL}/affiliate?streamer=${streamer}`);
        expect(response.status).toEqual(200);
        const userData = response.data;
        expect(userData).toEqual(mock.affiliate);
    });
    it('User is partner', async () => {
        const response = await axios.get(`${apiURL}${userApiURL}/partner?streamer=${streamer}`);
        expect(response.status).toEqual(200);
        const userData = response.data;
